...
import '../../Asset/css/education.css';
...
const Education = () => {
    ...
    return (
        <div className="container">
                ...
                <div className="col-lg-6 col-md-12 mt-5 text-center">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-6 text-center">
                            <Link to='https://codefirstacademy.com/' target='_blank'> <img src={codefirstlogo} alt="CodeFirst Academy" className='img-fluid' /></Link>
                            <p>CodeFirst Academy</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="row mt-5">
                <div className="col-md-4 col-sm-12 mb-3 mt-5">
                ...
                <div className="col-md-8 col-sm-12">
                    <div className="card">
                        ...
                        <div className="card-body d-flex flex-column">
                            <div className="text-start">
                                <p>⚡ Programming languages (C, C++, Java), database management systems, and software development methodologies etc.</p>
