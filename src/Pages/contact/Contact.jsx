    ...
    return (
        <div className="container">
                    ...
                    <section className="mt-5">
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6 col-sm-12 mt-2">
                                <button className="btn text-white w-100 resumebtn" style={{ backgroundColor: 'crimson' }} onClick={seeResume}>
                                    SEE MY RESUME
                                </button>
                            </div>
                        </div>
            ...
            <div className="row mt-3">
                ...
                <div className="col-md-7">
                    <img src={addressimage} alt="Address" className="img-fluid" />
                </div>
                <div className="col-md-5">
                    <p className="text-muted" style={{ fontSize: '1.5rem' }}>
                        Pune, 411014
                    </p>
                    <button className="btn text-white w-100" onClick={seeLocation} style={{ backgroundColor: '#001C55' }}>Visit On Google Map</button>
                </div>
            </div>
